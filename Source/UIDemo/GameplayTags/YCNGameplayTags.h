...
namespace YCNGameplayTags
{
	...
	UIDEMO_API UE_DECLARE_GAMEPLAY_TAG_EXTERN(YCN_Widget_Confirm);
	UIDEMO_API UE_DECLARE_GAMEPLAY_TAG_EXTERN(YCN_Widget_Option);

	//Options Image
	UIDEMO_API UE_DECLARE_GAMEPLAY_TAG_EXTERN(YCN_Image_TestImage);
}